...
class MainMenuButton(object):
    def __init__(self, name, x, y, width, height, shift):
        ...
        self.image_idle = pygame.image.load("button.png")
        self.image_pressed = pygame.image.load("button_pressed.png")
        self.image = self.image.idle
...
def main():
    ...
    buttons = [MainMenuButton("Play", 300, 320, 200, 50, 70),
               MainMenuButton("Help", 300, 380, 200, 50, 40),
               MainMenuButton("About", 300, 440, 200, 50, 40),
               MainMenuButton("Exit", 300, 500, 200, 50, 70)]
